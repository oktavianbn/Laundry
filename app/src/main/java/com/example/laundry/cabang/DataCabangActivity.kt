...
class DataCabangActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomBar()
        toolbar()
        tvJudul.text = getString(R.string.Cabang)
    ...
    fun bottomBar() {
        ...
        cvTambahData.setOnClickListener {
            ...
            intent.putExtra("Judul", getString(R.string.TambahCabang))
...
//                performSearch(s.toString())
    ...
    fun getData() {
        val query = myRef.orderByChild("cabang").limitToLast(100)
        query.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@DataCabangActivity, error.message, Toast.LENGTH_SHORT).show()
            }
        }
        )
    }
